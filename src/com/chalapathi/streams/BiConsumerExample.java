...
public class BiConsumerExample implements BiConsumer<String, Integer> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        map.forEach(BiConsumerExample::printEntry);

        System.out.println();
        map.forEach(new BiConsumerExample()::printEntryInstanceMethod);
    }
    ...
    public  void printEntryInstanceMethod(String key, Integer value) {
